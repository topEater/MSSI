...
# result = (result+result_90_origin+result_180_origin+result_270_origin) / 4
...
# np.save("./data/voidresultsWithMSSI-self21.npy",result)
np.save("./data/randomresultsWithMSSI-self75.npy",result)
